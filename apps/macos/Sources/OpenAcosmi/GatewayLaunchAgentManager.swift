...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.openacosmi", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".openacosmi/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.openacosmiCommand(
            subcommand: "gateway",
