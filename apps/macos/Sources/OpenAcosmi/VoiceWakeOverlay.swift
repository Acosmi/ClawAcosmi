...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.openacosmi", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other OpenAcosmi windows, but below the system’s pop-up menus.
