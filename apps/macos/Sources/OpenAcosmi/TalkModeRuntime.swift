...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.openacosmi", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.openacosmi", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [OpenAcosmiChatMessage] = messages.compactMap { item in
