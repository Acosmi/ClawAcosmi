...
final class AppState {
    ...
    init(preview: Bool = false) {
        ...
        let configRoot = OpenAcosmiConfigFile.loadDict()
    ...
    private func startConfigWatcher() {
        let configUrl = OpenAcosmiConfigFile.url()
    ...
    private func syncGatewayConfigIfNeeded() {
        ...
        Task { @MainActor in
            ...
            var root = OpenAcosmiConfigFile.loadDict()
            ...
            OpenAcosmiConfigFile.saveDict(root)
        }
    }
...
extension AppState {
    static var preview: AppState {
        ...
        state.remoteProjectRoot = "~/Projects/openacosmi"
        state.remoteCliPath = ""
        return state
    }
}
