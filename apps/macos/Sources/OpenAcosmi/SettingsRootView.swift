...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .openacosmiSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? OpenAcosmiPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? OpenAcosmiPaths.stateDirURL.path
...
extension Notification.Name {
    static let openacosmiSelectSettingsTab = Notification.Name("openacosmiSelectSettingsTab")
}
