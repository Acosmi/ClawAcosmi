...
enum OpenAcosmiConfigFile {
    private static let logger = Logger(subsystem: "ai.openacosmi", category: "config")
    ...
    static func stateDirURL() -> URL {
        OpenAcosmiPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        OpenAcosmiPaths.workspaceURL
    }
