...
final class CanvasManager {
    ...
    private static let logger = Logger(subsystem: "ai.openacosmi", category: "CanvasManager")
    ...
    private nonisolated static let canvasRoot: URL = {
        ...
        return base.appendingPathComponent("OpenAcosmi/canvas", isDirectory: true)
    }()
    ...
    private static func resolveA2UIHostUrl(from raw: String?) -> String? {
        ...
        return base.appendingPathComponent("__openacosmi__/a2ui/").absoluteString + "?platform=macos"
    }
