...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.openacosmi", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenAcosmiConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - OpenAcosmi Workspace
