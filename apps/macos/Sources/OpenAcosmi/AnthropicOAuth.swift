...
enum AnthropicAuthMode: Equatable {
    ...
    var shortLabel: String {
        switch self {
        case .oauthFile: "OAuth (OpenAcosmi token file)"
...
enum AnthropicAuthResolver {
    static func resolve(
        ...
        oauthStatus: OpenAcosmiOAuthStore.AnthropicOAuthStatus = OpenAcosmiOAuthStore
...
enum AnthropicOAuth {
    private static let logger = Logger(subsystem: "ai.openacosmi", category: "anthropic-oauth")
...
enum OpenAcosmiOAuthStore {
    static let oauthFilename = "oauth.json"
    private static let providerKey = "anthropic"
    private static let openacosmiOAuthDirEnv = "OPENACOSMI_OAUTH_DIR"
    ...
    enum AnthropicOAuthStatus: Equatable {
        ...
        var shortDescription: String {
            switch self {
            case .missingFile: "OpenAcosmi OAuth token file not found"
            case .unreadableFile: "OpenAcosmi OAuth token file not readable"
            case .invalidJSON: "OpenAcosmi OAuth token file invalid"
            case .missingProviderEntry: "No Anthropic entry in OpenAcosmi OAuth token file"
            case .missingTokens: "Anthropic entry missing tokens"
            case .connected: "OpenAcosmi OAuth credentials found"
            }
        }
    }

    static func oauthDir() -> URL {
        if let override = ProcessInfo.processInfo.environment[self.openacosmiOAuthDirEnv]?
