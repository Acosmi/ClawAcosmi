...
enum UIStrings {
    static let welcomeTitle = "Welcome to OpenAcosmi"
}
...
final class OnboardingController {
    ...
    func show() {
        if ProcessInfo.processInfo.isNixMode {
            ...
            UserDefaults.standard.set(true, forKey: "openacosmi.onboardingSeen")
...
struct OnboardingView: View {
    ...
    @State var anthropicAuthDetectedStatus: OpenAcosmiOAuthStore.AnthropicOAuthStatus = .missingFile
    ...
    @State var onboardingChatModel: OpenAcosmiChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g openacosmi@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: OpenAcosmiChatViewModel(
