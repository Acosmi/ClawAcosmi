...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/openacosmi/openacosmi") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/openacosmi/openacosmi")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://openacosmi.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "OpenAcosmiBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "OpenAcosmiBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "OpenAcosmiGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "OpenAcosmiGitCommit") as? String) ??
            "unknown"
    }
