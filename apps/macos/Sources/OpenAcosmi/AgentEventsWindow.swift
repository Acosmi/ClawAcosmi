...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: OpenAcosmiProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": OpenAcosmiProtocol.AnyCodable("start"),
                "name": OpenAcosmiProtocol.AnyCodable("bash"),
            ],
            summary: nil)
