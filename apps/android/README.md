## OpenAcosmi Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_openacosmi-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm openacosmi gateway --port 18789 --verbose
```
