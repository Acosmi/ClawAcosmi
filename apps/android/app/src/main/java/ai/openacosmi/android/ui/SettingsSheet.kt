package ai.openacosmi.android.ui
...
import ai.openacosmi.android.LocationMode
import ai.openacosmi.android.MainViewModel
import ai.openacosmi.android.NodeForegroundService
import ai.openacosmi.android.VoiceWakeMode
import ai.openacosmi.android.WakeWords
  ...
  LazyColumn(
      ...
      AnimatedVisibility(visible = voiceWakeMode != VoiceWakeMode.Off) {
        Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
          ListItem(
            ...
            supportingContent = { Text("Listens only while OpenAcosmi is open.") },
            trailingContent = {
              RadioButton(
    ...
    item {
      Column(verticalArrangement = Arrangement.spacedBy(6.dp), modifier = Modifier.fillMaxWidth()) {
        ...
        ListItem(
          ...
          supportingContent = { Text("Only while OpenAcosmi is open.") },
          trailingContent = {
            RadioButton(
    ...
    item {
      ListItem(
        ...
        supportingContent = { Text("Keeps the screen awake while OpenAcosmi is open.") },
