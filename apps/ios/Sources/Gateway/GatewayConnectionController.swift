...
final class GatewayConnectionController {
    ...
    private func currentCaps() -> [String] {
        var caps = [OpenAcosmiCapability.canvas.rawValue, OpenAcosmiCapability.screen.rawValue]
        ...
        if cameraEnabled { caps.append(OpenAcosmiCapability.camera.rawValue) }

        let voiceWakeEnabled = UserDefaults.standard.bool(forKey: VoiceWakePreferences.enabledKey)
        if voiceWakeEnabled { caps.append(OpenAcosmiCapability.voiceWake.rawValue) }

        let locationModeRaw = UserDefaults.standard.string(forKey: "location.enabledMode") ?? "off"
        let locationMode = OpenAcosmiLocationMode(rawValue: locationModeRaw) ?? .off
        if locationMode != .off { caps.append(OpenAcosmiCapability.location.rawValue) }

        caps.append(OpenAcosmiCapability.device.rawValue)
        caps.append(OpenAcosmiCapability.photos.rawValue)
        caps.append(OpenAcosmiCapability.contacts.rawValue)
        caps.append(OpenAcosmiCapability.calendar.rawValue)
        caps.append(OpenAcosmiCapability.reminders.rawValue)
        if Self.motionAvailable() {
            caps.append(OpenAcosmiCapability.motion.rawValue)
        }
    ...
    private func currentCommands() -> [String] {
        var commands: [String] = [
            ...
            OpenAcosmiSystemCommand.notify.rawValue,
            OpenAcosmiChatCommand.push.rawValue,
        ...
        if caps.contains(OpenAcosmiCapability.camera.rawValue) {
            commands.append(OpenAcosmiCameraCommand.list.rawValue)
            commands.append(OpenAcosmiCameraCommand.snap.rawValue)
            commands.append(OpenAcosmiCameraCommand.clip.rawValue)
        }
        if caps.contains(OpenAcosmiCapability.location.rawValue) {
            commands.append(OpenAcosmiLocationCommand.get.rawValue)
        }
        if caps.contains(OpenAcosmiCapability.device.rawValue) {
            commands.append(OpenAcosmiDeviceCommand.status.rawValue)
            commands.append(OpenAcosmiDeviceCommand.info.rawValue)
        }
        if caps.contains(OpenAcosmiCapability.photos.rawValue) {
            commands.append(OpenAcosmiPhotosCommand.latest.rawValue)
        }
        if caps.contains(OpenAcosmiCapability.contacts.rawValue) {
            commands.append(OpenAcosmiContactsCommand.search.rawValue)
            commands.append(OpenAcosmiContactsCommand.add.rawValue)
        }
        if caps.contains(OpenAcosmiCapability.calendar.rawValue) {
            commands.append(OpenAcosmiCalendarCommand.events.rawValue)
            commands.append(OpenAcosmiCalendarCommand.add.rawValue)
        }
        if caps.contains(OpenAcosmiCapability.reminders.rawValue) {
            commands.append(OpenAcosmiRemindersCommand.list.rawValue)
            commands.append(OpenAcosmiRemindersCommand.add.rawValue)
        }
        if caps.contains(OpenAcosmiCapability.motion.rawValue) {
            commands.append(OpenAcosmiMotionCommand.activity.rawValue)
            commands.append(OpenAcosmiMotionCommand.pedometer.rawValue)
        }
