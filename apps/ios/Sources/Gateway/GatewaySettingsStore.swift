...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.openacosmi.gateway"
    private static let nodeService = "ai.openacosmi.node"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.openacosmi.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.openacosmi.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .documentDirectory, in: .userDomainMask).first?
            .appendingPathComponent("openacosmi-gateway.log")
    }
