...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: OpenAcosmiPhotosLatestParams) async throws -> OpenAcosmiPhotosLatestPayload {
        ...
        var results: [OpenAcosmiPhotoPayload] = []
        ...
        return OpenAcosmiPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> OpenAcosmiPhotoPayload
    {
