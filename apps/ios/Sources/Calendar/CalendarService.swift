...
final class CalendarService: CalendarServicing {
    func events(params: OpenAcosmiCalendarEventsParams) async throws -> OpenAcosmiCalendarEventsPayload {
        ...
        let payload = selected.map { event in
            OpenAcosmiCalendarEventPayload(
        ...
        return OpenAcosmiCalendarEventsPayload(events: payload)
    }
    ...
    func add(params: OpenAcosmiCalendarAddParams) async throws -> OpenAcosmiCalendarAddPayload {
        ...
        let payload = OpenAcosmiCalendarEventPayload(
            identifier: event.eventIdentifier ?? UUID().uuidString,
        ...
        return OpenAcosmiCalendarAddPayload(event: payload)
    }
