...
final class ScreenController {
    ...
    /// Callback invoked when an openacosmi:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = OpenAcosmiKitResources.bundle
...
/// Handles navigation policy to intercept openacosmi:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept openacosmi:// deep links.
        if url.scheme?.lowercased() == "openacosmi" {
