...
struct SettingsTab: View {
    ...
    @AppStorage("location.enabledMode") private var locationEnabledModeRaw: String = OpenAcosmiLocationMode.off.rawValue
    ...
    private let gatewayLogger = Logger(subsystem: "ai.openacosmi.ios", category: "GatewaySettings")
            ...
            Form {
                ...
                Section("Device") {
                    DisclosureGroup("Features") {
                        ...
                        Text("Keeps the screen awake while OpenAcosmi is open.")
                            .font(.footnote)
                            .foregroundStyle(.secondary)
                    }
    ...
    private var locationMode: OpenAcosmiLocationMode {
        OpenAcosmiLocationMode(rawValue: self.locationEnabledModeRaw) ?? .off
    }
