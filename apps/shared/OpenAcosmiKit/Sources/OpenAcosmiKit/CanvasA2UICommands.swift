...
public enum OpenAcosmiCanvasA2UICommand: String, Codable, Sendable {
...
public struct OpenAcosmiCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct OpenAcosmiCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
