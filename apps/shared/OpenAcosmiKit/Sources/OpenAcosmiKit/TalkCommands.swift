...
public enum OpenAcosmiTalkCommand: String, Codable, Sendable {
...
public struct OpenAcosmiTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct OpenAcosmiTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
