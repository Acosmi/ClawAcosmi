...
public typealias OpenAcosmiPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias OpenAcosmiPlatformImage = UIImage
#endif

public struct OpenAcosmiChatUsageCost: Codable, Hashable, Sendable {
...
public struct OpenAcosmiChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: OpenAcosmiChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(OpenAcosmiChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct OpenAcosmiChatMessageContent: Codable, Hashable, Sendable {
...
public struct OpenAcosmiChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [OpenAcosmiChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: OpenAcosmiChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [OpenAcosmiChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: OpenAcosmiChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(OpenAcosmiChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([OpenAcosmiChatMessageContent].self, forKey: .content) {
...
public struct OpenAcosmiChatHistoryPayload: Codable, Sendable {
...
public struct OpenAcosmiSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct OpenAcosmiSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [OpenAcosmiSessionPreviewItem]
}

public struct OpenAcosmiSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [OpenAcosmiSessionPreviewEntry]

    public init(ts: Int, previews: [OpenAcosmiSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct OpenAcosmiChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct OpenAcosmiChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct OpenAcosmiAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct OpenAcosmiChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct OpenAcosmiGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct OpenAcosmiPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: OpenAcosmiPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: OpenAcosmiPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct OpenAcosmiChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
