...
@MainActor
public struct OpenAcosmiChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: OpenAcosmiChatViewModel
    ...
    public init(
        viewModel: OpenAcosmiChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                OpenAcosmiChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [OpenAcosmiChatMessage] {
        let base: [OpenAcosmiChatMessage]
    ...
    private func mergeToolResults(in messages: [OpenAcosmiChatMessage]) -> [OpenAcosmiChatMessage] {
        ...
        for message in messages {
            ...
            let merged = OpenAcosmiChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: OpenAcosmiChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: OpenAcosmiChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: OpenAcosmiChatMessage) -> String {
