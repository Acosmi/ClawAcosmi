...
function renderPendingDevice(req: PendingDevice, props: NodesProps) {
  ...
  const role = req.role?.trim() ? t("nodes.role", { role: req.role }) : t("nodes.roleNone");
...
function renderPairedDevice(device: PairedDevice, props: NodesProps) {
  ...
  const roles = t("nodes.roles", { list: formatList(device.roles) });
  const scopes = t("nodes.scopes", { list: formatList(device.scopes) });
...
function renderTokenRow(deviceId: string, token: DeviceTokenSummary, props: NodesProps) {
  ...
  const scopes = t("nodes.scopes", { list: formatList(token.scopes) });
    ...
    <section class="card">
      ...
      ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            ...
            <button class="btn" ?disabled=${state.configLoading} @click=${state.onLoadConfig}>
              ${state.configLoading ? t("nodes.loading") : t("nodes.loadConfigBtn")}
            </button>
          </div>`
      : html`
            <div class="list" style="margin-top: 16px;">
          ...
          (node) =>
            html`<option
                  ...
                  ${!supportsBinding
          ? html`
                          <div class="muted">${t("nodes.noRunNodes")}</div>
                        `
          : nothing
        }
                </div>
    ...
    <section class="card">
      ...
      ? html`<div class="row" style="margin-top: 12px; gap: 12px;">
            ...
            <button class="btn" ?disabled=${state.loading || !targetReady} @click=${state.onLoad}>
              ${state.loading ? t("nodes.loading") : t("nodes.loadApprovalsBtn")}
            </button>
          </div>`
      : html`
    ...
    <div class="list" style="margin-top: 16px;">
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults ? t("nodes.defaultSecurityMode") : t("nodes.defaultIs", { value: defaults.security })}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
      ...
      ? html`<option value="__default__" ?selected=${securityValue === "__default__"}>
                    ${t("nodes.useDefaultOption", { value: defaults.security })}
                  </option>`
      : nothing
    }
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults ? t("nodes.defaultPromptPolicy") : t("nodes.defaultIs", { value: defaults.ask })}
          </div>
        </div>
        <div class="list-meta">
          <label class="field">
      ...
      ? html`<option value="__default__" ?selected=${askValue === "__default__"}>
                    ${t("nodes.useDefaultOption", { value: defaults.ask })}
                  </option>`
      : nothing
    }
              ${getAskOptions().map(
      ...
      : t("nodes.defaultIs", { value: defaults.askFallback })
    }
          </div>
        </div>
        <div class="list-meta">
      ...
      ? html`<option value="__default__" ?selected=${askFallbackValue === "__default__"}>
                    ${t("nodes.useDefaultOption", { value: defaults.askFallback })}
                  </option>`
      : nothing
    }
              ${getSecurityOptions().map(
      ...
      <div class="list-item">
        <div class="list-main">
          <div class="list-title">${t("nodes.autoAllowTitle")}</div>
          <div class="list-sub">
            ${isDefaults
      ? t("nodes.autoAllowDefault")
      : autoIsDefault
        ? t("nodes.autoAllowUsing", { value: defaults.autoAllowSkills ? t("nodes.on") : t("nodes.off") })
        : t("nodes.autoAllowOverride", { value: autoEffective ? t("nodes.on") : t("nodes.off") })
    }
          </div>
        </div>
        <div class="list-meta">
