---
summary: "OpenAcosmi on DigitalOcean (simple paid VPS option)"
read_when:
  - Setting up OpenAcosmi on DigitalOcean
  - Looking for cheap VPS hosting for OpenAcosmi
title: "DigitalOcean"
---

# OpenAcosmi on DigitalOcean

## Goal

Run a persistent OpenAcosmi Gateway on DigitalOcean for **$6/month** (or $4/mo with reserved pricing).
...
- `~/.openacosmi/workspace/` — workspace (SOUL.md, memory, etc.)
