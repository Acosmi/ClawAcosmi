...
- Same path: run the app from a fixed location (for OpenAcosmi, `dist/OpenAcosmi.app`).
...
Workaround: move files into the OpenAcosmi workspace (`~/.openacosmi/workspace`) if you want to avoid per-folder grants.
