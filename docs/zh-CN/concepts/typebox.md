...
- 生成的 Swift 模型：`apps/macos/Sources/OpenAcosmiProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/openacosmi/openacosmi/main/dist/protocol.schema.json
