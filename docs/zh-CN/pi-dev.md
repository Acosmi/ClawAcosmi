...
本指南总结了在 OpenAcosmi 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenAcosmi 状态目录下。默认为 `~/.openacosmi`。如果设置了 `OPENACOSMI_STATE_DIR`，则使用该目录。

要重置所有内容：

- `openacosmi.json` 用于配置
...
- https://docs.openacosmi.ai/testing
- https://docs.openacosmi.ai/start/getting-started
