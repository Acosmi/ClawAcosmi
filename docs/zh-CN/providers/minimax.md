...
```bash
openacosmi plugins enable minimax-portal-auth  # 如果已加载则跳过
openacosmi gateway restart  # 如果 Gateway 网关已在运行则重启
...
详情参见 [MiniMax OAuth 插件 README](https://github.com/openacosmi/openacosmi/tree/main/extensions/minimax-portal-auth)。
