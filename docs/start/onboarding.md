---
summary: "First-run onboarding flow for OpenAcosmi (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenAcosmi">
...
<Step title="CLI">
  ...
  The app can install the global `openacosmi` CLI via npm/pnpm so terminal
