---
summary: "Run OpenAcosmi Gateway 24/7 on a cheap Hetzner VPS (Docker) with durable state and baked-in binaries"
read_when:
  - You want OpenAcosmi running 24/7 on a cloud VPS (not your laptop)
  - You want a production-grade, always-on Gateway on your own VPS
  - You want full control over persistence, binaries, and restart behavior
  - You are running OpenAcosmi in Docker on Hetzner or a similar provider
title: "Hetzner"
---

# OpenAcosmi on Hetzner (Docker, Production VPS Guide)
