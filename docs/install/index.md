---
summary: "Install OpenAcosmi — installer script, npm/pnpm, from source, Docker, and more"
read_when:
  ...
  <Accordion title="From source" icon="github">
    ...
    <Steps>
      ...
      <Step title="Link the CLI">
        Make the `openacosmi` command available globally:

        ```bash
        pnpm link --global
        ```

        Alternatively, skip the link and run commands via `pnpm openacosmi ...` from inside the repo.
      </Step>
