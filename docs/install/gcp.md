---
summary: "Run OpenAcosmi Gateway 24/7 on a GCP Compute Engine VM (Docker) with durable state"
read_when:
  - You want OpenAcosmi running 24/7 on GCP
  - You want a production-grade, always-on Gateway on your own VM
  - You want full control over persistence, binaries, and restart behavior
title: "GCP"
---

# OpenAcosmi on GCP Compute Engine (Docker, Production VPS Guide)
