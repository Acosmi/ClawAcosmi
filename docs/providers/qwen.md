---
summary: "Use Qwen OAuth (free tier) in OpenAcosmi"
read_when:
  - You want to use Qwen with OpenAcosmi
...
If you already logged in with the Qwen Code CLI, OpenAcosmi will sync credentials
