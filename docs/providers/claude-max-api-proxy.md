...
You can point OpenAcosmi at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenAcosmi
...
- [Anthropic provider](/providers/anthropic) - Native OpenAcosmi integration with Claude setup-token or API keys
