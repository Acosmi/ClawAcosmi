---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenAcosmi"
read_when:
  - You want Xiaomi MiMo models in OpenAcosmi
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenAcosmi uses
