...
read_when:
  - Setting up Zalo Personal for OpenAcosmi
...
- Install via CLI: `openacosmi plugins install @openacosmi/zalouser`
- Or from a source checkout: `openacosmi plugins install ./extensions/zalouser`
