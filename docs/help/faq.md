---
summary: "Frequently asked questions about OpenAcosmi setup, configuration, and usage"
title: "FAQ"
---
...
If you don't have a global install yet, run it via `pnpm openacosmi onboard`.
...
- Persist `/home/node` with `OPENACOSMI_HOME_VOLUME` so caches survive.
