...
| 指标 | 值 | 备注 |
|------|----|----- |
| 冷启动时间 (StartGateway→Ready) | 106.37 ms | — |
| 空闲网关 HeapAlloc | 74.40 KB | HeapInuse=4.21 MB, Sys=23.64 MB |
| 方法分发延迟: health | 1444 ns/op | — |
| Registry 查找（70+ 方法） | 420 ns/op | — |
| Transcript 写入 | 77.2 µs/op | — |
| Transcript 读取 (100 msgs) | 35107.7 µs/op | — |
| 聊天延迟 P50 / P95 / P99 | 2988 / 7471 / 8244 µs | — |
