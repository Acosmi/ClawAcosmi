...
read_when:
  - You want to place an outbound voice call from OpenAcosmi
...
Voice calls for OpenAcosmi via a plugin. Supports outbound notifications and
...
- Use `openacosmi voicecall ...` or the `voice_call` tool
...
openacosmi voicecall speak --call-id <id> --message "One moment"
