...
read_when:
  - You want Zalo Personal (unofficial) support in OpenAcosmi
...
Zalo Personal support for OpenAcosmi via a plugin, using `zca-cli` to automate a normal Zalo user account.
