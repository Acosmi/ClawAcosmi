...
read_when:
  - You are building a OpenAcosmi plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (openacosmi.plugin.json)

Every plugin **must** ship a `openacosmi.plugin.json` file in the **plugin root**.
OpenAcosmi uses this manifest to validate configuration **without executing plugin
