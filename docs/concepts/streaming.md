...
OpenAcosmi has two separate “streaming” layers:
...
When block streaming is enabled, OpenAcosmi can **merge consecutive block chunks**
...
When draft streaming is active, OpenAcosmi disables block streaming for that reply to avoid double-streaming.
