---
name: pi-dev
description: "Pi Development Workflow"
---

# Pi Development Workflow

This guide summarizes a sane workflow for working on the pi integration in OpenAcosmi.
...
- Trigger the agent directly:
  - `pnpm openacosmi agent --message "Hello" --thinking low`
...
State lives under the OpenAcosmi state directory. Default is `~/.openacosmi`. If `OPENACOSMI_STATE_DIR` is set, use that directory instead.

To reset everything:

- `openacosmi.json` for config
...
- [https://docs.openacosmi.ai/testing](https://docs.openacosmi.ai/testing)
- [https://docs.openacosmi.ai/start/getting-started](https://docs.openacosmi.ai/start/getting-started)
