---
name: qianfan
description: "Use Qianfan's unified API to access many models in Claw Acismi"
---
...
3. Claw Acismi installed on your system
...
4. Copy the API key for use with Claw Acismi
...
- [Claw Acismi Configuration](/gateway/configuration)
