---
name: qianfan
description: "Use Qianfan's unified API to access many models in OpenAcosmi"
---
...
3. OpenAcosmi installed on your system
...
4. Copy the API key for use with OpenAcosmi
...
- [OpenAcosmi Configuration](/gateway/configuration)
