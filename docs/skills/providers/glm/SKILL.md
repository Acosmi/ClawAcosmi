---
name: glm
description: "GLM model family overview + how to use it in Claw Acismi"
---

# GLM models

GLM is a **model family** (not a company) available through the Z.AI platform. In Claw Acismi, GLM
