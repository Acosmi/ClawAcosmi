---
name: venice
description: "Use Venice AI privacy-focused models in Claw Acismi"
---
...
After setup, Claw Acismi shows all available Venice models. Pick based on your needs:
...
Claw Acismi automatically discovers models from the Venice API when `VENICE_API_KEY` is set. If the API is unreachable, it falls back to a static catalog.
