...
You can point Claw Acismi at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Claw Acismi
...
- [Anthropic provider](/providers/anthropic) - Native Claw Acismi integration with Claude setup-token or API keys
