---
name: synthetic
description: "Use Synthetic's Anthropic-compatible API in Claw Acismi"
---

# Synthetic

Synthetic exposes Anthropic-compatible endpoints. Claw Acismi registers it as the
...
Note: Claw Acismi's Anthropic client appends `/v1` to the base URL, so use
