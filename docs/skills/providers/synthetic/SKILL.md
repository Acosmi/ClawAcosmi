---
name: synthetic
description: "Use Synthetic's Anthropic-compatible API in OpenAcosmi"
---

# Synthetic

Synthetic exposes Anthropic-compatible endpoints. OpenAcosmi registers it as the
...
Note: OpenAcosmi's Anthropic client appends `/v1` to the base URL, so use
