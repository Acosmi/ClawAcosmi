...
Deepgram is a speech-to-text API. In Claw Acismi it is used for **inbound audio/voice note
transcription** via `tools.media.audio`.

When enabled, Claw Acismi uploads the audio file to Deepgram and injects the transcript
