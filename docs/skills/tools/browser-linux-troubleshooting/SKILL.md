...
description: "Fix Chrome/Brave/Edge/Chromium CDP startup issues for Claw Acismi browser control on Linux"
---
...
Claw Acismi's browser control server fails to launch Chrome/Brave/Edge/Chromium with the error:
...
On Ubuntu (and many Linux distros), the default Chromium installation is a **snap package**. Snap's AppArmor confinement interferes with how Claw Acismi spawns and monitors the browser process.
