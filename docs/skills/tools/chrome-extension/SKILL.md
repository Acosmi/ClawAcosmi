...
description: "Chrome extension: let Claw Acismi drive your existing Chrome tab"
---

# Chrome extension (browser relay)

The Claw Acismi Chrome extension lets the agent control your **existing Chrome tabs** (your normal Chrome window) instead of launching a separate openacosmi-managed Chrome profile.
...
Claw Acismi then controls the attached tab through the normal `browser` tool surface (selecting the right profile).
...
升级 Claw Acismi 后在 `chrome://extensions` 中 Reload 扩展即可。
...
- Open the tab you want Claw Acismi to control.
